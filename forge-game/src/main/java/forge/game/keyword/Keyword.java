...
public enum Keyword {
    ...
    ASH_OF_WAR("Ash of War", SimpleKeyword.class, false, "This Aura can enchant creatures or Equipment. If it enchants an Equipment, creatures equipped with that Equipment are treated as if they were enchanted by this Aura."),
    ...
    COALESCE("Coalesce", SimpleKeyword.class, true, "For every two cards you put into your graveyard from among cards you own in exile while casting this spell, this spell costs {1} less to cast."),
    ...
    DERANGE("Derange", SimpleKeyword.class, false, "Whenever this creature attacks, you may mill a card. If you do, defending player loses 1 life."),
    ...
    FOCUS("Focus", SimpleKeyword.class, false, "During your main phase, you may exile this card from your hand and pay its mana cost. At the beginning of your next upkeep, cast it without paying its mana cost."),
    ...
    HUMBLED("Humbled", Humbled.class, false, "This permanent enters with {%d:defeat counter} on it. As long as it has a defeat counter on it, it's an enchantment and loses all other card types. At the beginning of your upkeep, remove a defeat counter from it."),
    ...
    IMMUNITY("Immunity", KeywordWithCost.class, false, "Spells your opponents cast that target this creature cost %s more to cast."),
    ...
    REANIMATE("Reanimate", SimpleKeyword.class, false, "You may cast this card from your graveyard by sacrificing a creature in addition to paying its other costs."),
    ...
    RESONANCE("Resonance", KeywordWithCost.class, false, "If you cast this spell for %s, exile it as it resolves. As you cast your next instant or sorcery spell, put this card into your graveyard and you may add its effects and colors to that spell."),
    ...
    RIG("Rig", KeywordWithCost.class, false, "%s: This stops being a creature and becomes an Equipment until your next upkeep. Attach it to target creature you control. Rig only as a sorcery."),
    ...
    SPIRIT_ASH("Spirit Ash", KeywordWithCost.class, false, "%s, Exile this card from your graveyard: Create a token that's a copy of this creature, except it's a Spirit enchantment creature in addition to its other types. Activate only as a sorcery."),
    ...
    TALISMAN("Talisman", SimpleKeyword.class, true, "If equipped creature would be destroyed, instead remove all damage from it and destroy this Equipment."),
    ...
    UNITY("Unity", SimpleKeyword.class, false, "As this permanent enters, you may pay any number of unity counters. This permanent enters with a unity counter on it for each unity counter paid this way."),
